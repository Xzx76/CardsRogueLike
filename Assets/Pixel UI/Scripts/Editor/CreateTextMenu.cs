...
namespace PixelsoftGames.PixelUI
{
    ...
    public class CreateTextMenu : MonoBehaviour
    {
        ...
        const string path = "Prefabs/";
            ...
            [MenuItem("Pixel UI/Create/" + skinName + "/Mplus_hzk Text (Primary)")]
            static void CreateMplusTextPrimary()
            {
                InstantiateObj(skinPath + "Mplus_hzk Text (Primary)");
            }
            [MenuItem("Pixel UI/Create/" + skinName + "/Mplus_hzk Text (Sub)")]
            static void CreateMplusTextSub()
            {
                InstantiateObj(skinPath + "Mplus_hzk Text (Sub)");
            }
